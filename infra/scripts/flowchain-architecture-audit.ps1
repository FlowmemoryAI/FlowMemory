...
$deploymentAutomationReady = $publicRpcDeploymentAutomationStatus -eq "passed" `
    ...
    -and ((Get-ArchitectureProp -Object $deploymentAutomationChecks -Name "commandPlanIncludesOpsLaunchWatch" -Default $false) -eq $true) `
...
$ownerGoLiveHandoffSafe = $ownerGoLiveHandoffStatus -eq "passed" `
    ...
    -and ((Get-ArchitectureProp -Object $ownerGoLiveHandoffChecks -Name "launchSequenceCoversOpsLaunchWatch" -Default $false) -eq $true) `
