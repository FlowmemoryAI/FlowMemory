...
$paths = [ordered]@{
    ...
    externalTesterClient = Join-Path $repoRoot "examples/flowchain-external-tester-client.mjs"
...
$checks = [ordered]@{
    ...
    packageScriptClientPresent = Test-PackageScript -Name "flowchain:external-tester:client"
    packageScriptClientValidationPresent = Test-PackageScript -Name "flowchain:external-tester:client:validate"
    ...
    externalTesterClientExists = Test-Path -LiteralPath $paths.externalTesterClient
