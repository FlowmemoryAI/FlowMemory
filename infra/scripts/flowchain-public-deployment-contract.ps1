...
$deploymentAutomationReady = $publicRpcDeploymentAutomationStatus -eq "passed" `
    ...
    -and ((Get-DeploymentProp -Object $deploymentAutomationChecks -Name "commandPlanIncludesOpsLaunchWatch" -Default $false) -eq $true) `
