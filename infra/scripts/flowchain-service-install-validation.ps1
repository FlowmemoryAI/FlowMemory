...
$scheduledTaskTriggerMode = [string](Get-ServiceInstallValidationProp -Object $planScheduledTask -Name "triggerMode" -Default "")
$scheduledTaskTriggers = @((Get-ServiceInstallValidationProp -Object $planScheduledTask -Name "triggers" -Default @()))
...
$bridgeRelayerTriggerMode = [string](Get-ServiceInstallValidationProp -Object $bridgeRelayerPlanScheduledTask -Name "triggerMode" -Default "")
$bridgeRelayerTriggers = @((Get-ServiceInstallValidationProp -Object $bridgeRelayerPlanScheduledTask -Name "triggers" -Default @()))
...
$checks = [ordered]@{
    ...
    triggerModeBothByDefault = $scheduledTaskTriggerMode -eq "Both"
    triggerIncludesStartup = $scheduledTaskTriggers -contains "AtStartup"
    triggerIncludesLogon = $scheduledTaskTriggers -contains "AtLogOn"
    rebootPersistentTrigger = (Get-ServiceInstallValidationProp -Object $planChecks -Name "rebootPersistentTrigger" -Default $false) -eq $true
    ...
    bridgeRelayerOptInKeepsBothTriggers = $bridgeRelayerTriggerMode -eq "Both" -and $bridgeRelayerTriggers -contains "AtStartup" -and $bridgeRelayerTriggers -contains "AtLogOn"
