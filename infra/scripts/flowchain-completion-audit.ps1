...
$ownerGoLiveHandoffRequiredChecks = @(
    ...
    "launchSequenceCoversOpsLaunchWatch",
...
$publicRpcDeploymentAutomationRequiredChecks = @(
    ...
    "commandPlanIncludesOpsLaunchWatch",
...
$publicRpcDeploymentAutomationPassed = $publicRpcDeploymentAutomationExitCode -eq 0 `
    ...
    -and ((Get-AuditProp -Object $publicRpcDeploymentAutomationChecks -Name "renderedOwnerHostApplyPowerShellWritten" -Default $false) -eq $true) `
    -and ((Get-AuditProp -Object $publicRpcDeploymentAutomationChecks -Name "renderedOwnerHostApplyPowerShellHasPlanApplyRollback" -Default $false) -eq $true) `
    -and ((Get-AuditProp -Object $publicRpcDeploymentAutomationChecks -Name "renderedOwnerHostApplyPowerShellParses" -Default $false) -eq $true) `
    -and ((Get-AuditProp -Object $publicRpcDeploymentAutomationChecks -Name "renderedOwnerHostApplyPowerShellVerifiesHashes" -Default $false) -eq $true) `
    -and ((Get-AuditProp -Object $publicRpcDeploymentAutomationChecks -Name "renderedOwnerHostApplyPowerShellRunsPostDeployProof" -Default $false) -eq $true) `
    ...
    -and ((Get-AuditProp -Object $publicRpcDeploymentAutomationChecks -Name "ownerHostApplyPlanIncludesWindowsOwnerApplyScript" -Default $false) -eq $true) `
