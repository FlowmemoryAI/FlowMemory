...
/// @title FlowMemorySettlementSpine
/// @notice Compact local/test settlement event spine for FlowMemory object commitments.
...
contract FlowMemorySettlementSpine {
    ...
    bytes32 public constant BRIDGE_DEPOSIT_OBJECT = keccak256("flowmemory.object.bridge-deposit.v0");
    bytes32 public constant BRIDGE_CREDIT_OBJECT = keccak256("flowmemory.object.bridge-credit.v0");
    bytes32 public constant BRIDGE_WITHDRAWAL_INTENT_OBJECT =
        keccak256("flowmemory.object.bridge-withdrawal-intent.v0");
    bytes32 public constant MEMORY_OBJECT = keccak256("flowmemory.object.memory.v0");
    bytes32 public constant FINALITY_OBJECT = keccak256("flowmemory.object.finality.v0");
    ...
    event FlowMemoryObjectCommitted(
    ...
    function commitObject(
        ...
        emit FlowMemoryObjectCommitted({
            objectId: objectId,
            rootfieldId: rootfieldId,
            objectType: objectType,
            submitter: msg.sender,
