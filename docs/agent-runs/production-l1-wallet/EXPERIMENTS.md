# Owner-Gated L1 Wallet Experiments
...
| 2026-05-14 | `npm run flowchain:real-value-pilot:wallet` | Pass | Runs pilot wallet E2E and owner-gated L1 wallet E2E together. |
