...
Generated: 2026-05-19T10:38:05.6590655+00:00
...
| --- | --- | --- | --- | --- |
| service-status | passed | passed | status=passed; latestHeight=86693; finalizedHeight=86693; failedChecksCount=0 | `npm run flowchain:service:status` |
...
| operator-doctor | blocked-owner-input | blocked | status=blocked; latestHeight=86589; finalizedHeight=86589; blockedOnlyOnOwnerInputs=True; failedChecksCount=0 | `npm run flowchain:doctor -- -ReportPath docs/agent-runs/live-product-infra-rpc/operator-doctor-report.json` |
...
| node-operator-package | passed | passed | status=passed; commandCount=48; runbookCount=29; evidenceReportCount=37; packageScriptsPresent=True; failedChecksCount=0 | `npm run flowchain:operator:package` |
| node-operator-package-verify | passed | passed | status=passed; commandCount=48; expectedFileCount=55; ownerInputNameCount=17; failedChecksCount=0 | `npm run flowchain:operator:package:verify` |
