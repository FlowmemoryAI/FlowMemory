...
Generated: 2026-05-19T10:04:30.8905605+00:00
...
| --- | --- | --- | --- | --- |
| service-status | passed | passed | status=passed; latestHeight=86267; finalizedHeight=86267; failedChecksCount=0 | `npm run flowchain:service:status` |
...
| operator-doctor | blocked-owner-input | blocked | status=blocked; latestHeight=81006; finalizedHeight=81006; blockedOnlyOnOwnerInputs=True; failedChecksCount=0 | `npm run flowchain:doctor -- -ReportPath docs/agent-runs/live-product-infra-rpc/operator-doctor-report.json` |
...
| node-operator-package | passed | passed | status=passed; commandCount=46; runbookCount=27; evidenceReportCount=37; packageScriptsPresent=True; failedChecksCount=0 | `npm run flowchain:operator:package` |
