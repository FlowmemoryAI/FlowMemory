...
Generated: 2026-05-17T20:55:58.1859284+00:00
...
| --- | --- | --- | --- | --- |
| service-status | passed | passed | status=passed; latestHeight=59881; finalizedHeight=59881 | `npm run flowchain:service:status` |
| service-monitor | passed | passed | status=passed; latestHeight=59881 | `npm run flowchain:service:monitor -- -DurationSeconds 300 -PollSeconds 30` |
