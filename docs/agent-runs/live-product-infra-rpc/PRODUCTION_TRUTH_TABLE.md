...
Generated: 2026-05-18T04:52:42.8015053+00:00
...
| --- | --- | --- | --- | --- |
| service-status | passed | passed | status=passed; latestHeight=65668; finalizedHeight=65668 | `npm run flowchain:service:status` |
| service-monitor | passed | passed | status=passed; latestHeight=64928 | `npm run flowchain:service:monitor -- -DurationSeconds 300 -PollSeconds 30` |
| operator-doctor | blocked-owner-input | blocked | status=blocked; latestHeight=65668; finalizedHeight=65668; blockedOnlyOnOwnerInputs=True; failedChecksCount=0 | `npm run flowchain:doctor -- -ReportPath docs/agent-runs/live-product-infra-rpc/operator-doctor-report.json` |
...
| ops-snapshot | blocked-owner-input | blocked | status=blocked; latestHeight=64928; finalizedHeight=64928 | `npm run flowchain:ops:snapshot -- -AllowBlocked` |
