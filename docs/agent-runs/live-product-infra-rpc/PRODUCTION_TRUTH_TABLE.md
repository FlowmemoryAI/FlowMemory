...
Generated: 2026-05-17T16:10:19.2750525+00:00
...
| --- | --- | --- | --- | --- |
| service-status | passed | passed | status=passed; latestHeight=56856; finalizedHeight=56856 | `npm run flowchain:service:status` |
| service-monitor | passed | passed | status=passed; latestHeight=56586 | `npm run flowchain:service:monitor -- -DurationSeconds 300 -PollSeconds 30` |
