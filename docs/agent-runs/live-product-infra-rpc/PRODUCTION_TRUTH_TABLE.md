...
Generated: 2026-05-17T13:38:34.9125472+00:00
...
| --- | --- | --- | --- | --- |
| service-status | passed | passed | status=passed; latestHeight=55209; finalizedHeight=55209 | `npm run flowchain:service:status` |
| service-monitor | passed | passed | status=passed; latestHeight=54939 | `npm run flowchain:service:monitor -- -DurationSeconds 300 -PollSeconds 30` |
