...
Generated: 2026-05-16T11:02:10.8191248+00:00
...
| --- | --- | --- | --- | --- |
| service-status | passed | passed | status=passed; latestHeight=35521; finalizedHeight=35521 | `npm run flowchain:service:status` |
| service-monitor | passed | passed | status=passed; latestHeight=35325 | `npm run flowchain:service:monitor -- -DurationSeconds 300 -PollSeconds 30` |
