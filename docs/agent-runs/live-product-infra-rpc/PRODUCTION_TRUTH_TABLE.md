...
Generated: 2026-05-17T20:30:35.4475587+00:00
...
| --- | --- | --- | --- | --- |
| service-status | passed | passed | status=passed; latestHeight=59354; finalizedHeight=59354 | `npm run flowchain:service:status` |
| service-monitor | passed | passed | status=passed; latestHeight=59354 | `npm run flowchain:service:monitor -- -DurationSeconds 300 -PollSeconds 30` |
...
| ops-snapshot | blocked-owner-input | blocked | status=blocked; latestHeight=59354; finalizedHeight=59354 | `npm run flowchain:ops:snapshot -- -AllowBlocked` |
