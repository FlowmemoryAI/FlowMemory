...
| --- | --- | --- | --- | --- |
| service-status | passed | passed | status=passed; latestHeight=63944; finalizedHeight=63944 | `npm run flowchain:service:status` |
