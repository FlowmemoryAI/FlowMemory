...
Generated: 2026-05-17T00:01:56.3355109+00:00
...
| --- | --- | --- | --- | --- |
| service-status | passed | passed | status=passed; latestHeight=43609; finalizedHeight=43609 | `npm run flowchain:service:status` |
| service-monitor | passed | passed | status=passed; latestHeight=43312 | `npm run flowchain:service:monitor -- -DurationSeconds 300 -PollSeconds 30` |
