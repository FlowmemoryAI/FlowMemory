...
Generated: 2026-05-17T14:56:37.5194402+00:00
...
| --- | --- | --- | --- | --- |
| service-status | passed | passed | status=passed; latestHeight=56047; finalizedHeight=56047 | `npm run flowchain:service:status` |
| service-monitor | passed | passed | status=passed; latestHeight=55779 | `npm run flowchain:service:monitor -- -DurationSeconds 300 -PollSeconds 30` |
