...
Generated: 2026-05-21T17:13:32.2095625Z
...
| ops | `npm run flowchain:ops:launch-watch` | Verify every launch-critical operations lane has evidence, metrics, alert rules, and operator commands. |
...
| release | `npm run flowchain:live:capabilities` | Map user-facing chain capabilities to evidence and the remaining owner-input blockers. |
