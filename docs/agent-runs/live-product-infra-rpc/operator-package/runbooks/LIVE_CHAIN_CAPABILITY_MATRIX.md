...
Generated: 2026-05-21T17:13:14.2373050Z
Status: passed
...
| --- | --- | --- | --- | --- |
| RPC servers are running | passed | serviceStatus=passed; latestHeight=114051; finalizedHeight=114051 | none | `npm run flowchain:service:status` |
| Chain is producing blocks | passed | serviceMonitor=passed; heightAdvanced=True; latestHeight=114051 | none | `npm run flowchain:service:monitor -- -DurationSeconds 300 -PollSeconds 30` |
...
| Wallet-to-wallet transfers | passed | liveWallet=passed; testerTransfers=4; latestHeight=114051 | none | `npm run flowchain:wallet:live-service:e2e` |
