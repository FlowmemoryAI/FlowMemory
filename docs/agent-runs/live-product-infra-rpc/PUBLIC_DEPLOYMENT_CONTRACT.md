...
Generated: 2026-05-20T21:35:28.6949387Z
Status: blocked
...
| The public deployment origin service is running privately in live profile before any owner TLS edge is considered shareable. | passed | serviceStatus=passed, privateBind=True, latestHeight=106642, finalizedHeight=106642 |
...
| Owner deployment has a no-secret alert rule manifest that maps every current ops finding to operator commands without committing delivery credentials. | passed | alertRules=passed, criticalRules=29, blockedRules=7, unmappedCurrentFindingCodes=0 |
