...
Generated: 2026-05-17T11:25:50.6145885Z
Status: blocked
...
| The public deployment origin service is running privately in live profile before any owner TLS edge is considered shareable. | passed | serviceStatus=passed, privateBind=True, latestHeight=53525, finalizedHeight=53525 |
...
| The public deployment has a local production-shaped proof for authenticated tester wallet creation, capped tester sends, balance settlement, and over-cap rejection. | passed | gatewayStatus=passed, transferAccepted=True, capRejected=True |
