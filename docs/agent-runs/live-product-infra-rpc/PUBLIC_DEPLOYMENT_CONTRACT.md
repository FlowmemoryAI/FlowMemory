...
Generated: 2026-05-17T12:20:09.8830876Z
Status: blocked
...
| The public deployment origin service is running privately in live profile before any owner TLS edge is considered shareable. | passed | serviceStatus=passed, privateBind=True, latestHeight=53846, finalizedHeight=53846 |
...
| Owner deployment has a no-secret alert rule manifest that maps every current ops finding to operator commands without committing delivery credentials. | passed | alertRules=passed, criticalRules=7, blockedRules=6, unmappedCurrentFindingCodes=0 |
