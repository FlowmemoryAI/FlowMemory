...
Generated: 2026-05-20T08:50:02.8544406Z
Status: blocked
...
| The public deployment origin service is running privately in live profile before any owner TLS edge is considered shareable. | passed | serviceStatus=passed, privateBind=True, latestHeight=100185, finalizedHeight=100185 |
...
| Owner deployment has a no-secret alert rule manifest that maps every current ops finding to operator commands without committing delivery credentials. | passed | alertRules=passed, criticalRules=22, blockedRules=7, unmappedCurrentFindingCodes=0 |
