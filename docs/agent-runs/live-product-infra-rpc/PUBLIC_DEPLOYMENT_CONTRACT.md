...
Generated: 2026-05-20T19:33:47.9986559Z
Status: blocked
...
| The public deployment origin service is running privately in live profile before any owner TLS edge is considered shareable. | passed | serviceStatus=passed, privateBind=True, latestHeight=105654, finalizedHeight=105654 |
...
| Owner deployment has a no-secret alert rule manifest that maps every current ops finding to operator commands without committing delivery credentials. | passed | alertRules=passed, criticalRules=26, blockedRules=7, unmappedCurrentFindingCodes=0 |
