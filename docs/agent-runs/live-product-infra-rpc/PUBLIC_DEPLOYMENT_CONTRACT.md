...
Generated: 2026-05-21T04:40:29.4562746Z
Status: blocked
...
| The public deployment origin service is running privately in live profile before any owner TLS edge is considered shareable. | passed | serviceStatus=passed, privateBind=True, latestHeight=109408, finalizedHeight=109408 |
...
| Owner deployment has a no-secret alert rule manifest that maps every current ops finding to operator commands without committing delivery credentials. | passed | alertRules=passed, criticalRules=33, blockedRules=7, unmappedCurrentFindingCodes=0 |
...
| The owner TLS edge must pass endpoint, CORS, live security-header, rate-limit, readiness, and response-hygiene checks before sharing. | blocked | publicRpcStatus=blocked, publicRpcReady=False, canaryStatus=blocked, canaryReady=False, validationStatus=passed, validationPassed=True, abuseStatus=passed, abusePassed=True |
