...
Generated: 2026-05-21T17:21:55.7569045Z
Status: passed
...
- Latest height: 114146
- Finalized height: 114146
...
| --- | --- | --- | --- | --- |
| RPC servers are running | passed | serviceStatus=passed; latestHeight=114146; finalizedHeight=114146 | none | `npm run flowchain:service:status` |
| Chain is producing blocks | passed | serviceMonitor=passed; heightAdvanced=True; latestHeight=114146 | none | `npm run flowchain:service:monitor -- -DurationSeconds 300 -PollSeconds 30` |
...
| Wallet-to-wallet transfers | passed | liveWallet=passed; testerTransfers=4; latestHeight=114146 | none | `npm run flowchain:wallet:live-service:e2e` |
...
| Observability and alerting | passed | opsSnapshot=blocked; alerts=passed; metrics=passed; monitoringBundle=passed; launchWatch=passed | none | `npm run flowchain:ops:snapshot -- -AllowBlocked` |
