...
Generated: 2026-05-21T16:46:36.6273134Z
Status: passed
...
- Latest height: 113926
- Finalized height: 113926
...
| --- | --- | --- | --- | --- |
| RPC servers are running | passed | serviceStatus=passed; latestHeight=113926; finalizedHeight=113926 | none | `npm run flowchain:service:status` |
| Chain is producing blocks | passed | serviceMonitor=passed; heightAdvanced=True; latestHeight=113926 | none | `npm run flowchain:service:monitor -- -DurationSeconds 300 -PollSeconds 30` |
...
| Wallet-to-wallet transfers | passed | liveWallet=passed; testerTransfers=4; latestHeight=113926 | none | `npm run flowchain:wallet:live-service:e2e` |
