...
Status: implemented and verified in deterministic-fixture/gated-live modes.
...
7. [x] Add deterministic fixture pilot E2E that runs without live credentials.
...
- Fixture and readiness paths prove the bridge behavior without committing secrets or broadcasting a live transaction.
