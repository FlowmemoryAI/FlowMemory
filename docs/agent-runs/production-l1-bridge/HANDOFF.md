...
Status: capped Base `8453` owner pilot bridge path implemented, mock-proved, and live-gated.
...
- `bridge:deploy:dry-run`
- `bridge:deploy:base8453`
- `bridge:observe:mock`
- `bridge:observe:base8453`
- `bridge:credit:local`
- `bridge:credit:replay-check`
- `bridge:withdraw:intent`
- `bridge:release:evidence`
- `bridge:pause`
- `bridge:resume`
- `bridge:emergency-stop`
- `bridge:evidence:export`
- `bridge:pilot:mock:e2e`
- `bridge:pilot:live:check`
...
- optional: `FLOWCHAIN_PILOT_MAX_USD`
