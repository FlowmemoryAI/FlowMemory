...
- `npm test --prefix services/bridge-relayer` passed with 19 tests.
- `npm run flowchain:real-value-pilot:bridge` passed.
- `npm run flowchain:bridge:live:check` failed closed as expected without owner env values.
