...
- unconfigured machine status: `blocked`
...
- Owner live RPC URL, deployer key, lockbox address, supported token, asset decimals, caps, confirmation depth, bounded block range, and acknowledgement were not present in the worktree.
