...
- Deferred RD tracks are gated in `research/cryptography/FLOWMEMORY_RD_GATES.md`: Process-Witness, SEAL/dependency privacy, Synthetic Non-Amplification, advanced encrypted compute, GPU proofs, and audited production proof systems.
