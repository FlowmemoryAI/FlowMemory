  ...
  const records: WorkbenchRecord[] = [
    makeRecord("ops", WORKBENCH_LIVE_READINESS_REPORT_PATH, {
      ...
      facts: [
        ...
        { label: "owner env template", value: text(metrics.ownerEnvTemplateStatus) },
        { label: "owner env field guide", value: text(metrics.ownerEnvTemplateFieldGuideCount, "0") },
        { label: "owner env template no secrets", value: text(metrics.ownerEnvTemplateNoSecrets, "false") },
        ...
        { label: "bridge no-secret audit", value: text(metrics.bridgeNoSecretAuditStatus) },
        { label: "bridge no-secret scanned files", value: text(metrics.bridgeNoSecretAuditScannedFiles, "0") },
        { label: "bridge no-secret findings", value: text(metrics.bridgeNoSecretAuditFindings, "0") },
        { label: "bridge no-secret failed checks", value: text(metrics.bridgeNoSecretAuditFailedChecks, "0") },
        { label: "bridge runtime credit", value: text(metrics.bridgeRuntimeCreditValidationStatus) },
        { label: "bridge reconciliation schedule", value: text(metrics.bridgeReconciliationScheduleStatus) },
        { label: "bridge reconciliation interval minutes", value: text(metrics.bridgeReconciliationScheduleIntervalMinutes) },
        { label: "bridge reconciliation no mutation", value: text(metrics.bridgeReconciliationScheduleNoMutation, "false") },
